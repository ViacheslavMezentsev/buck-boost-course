...
void StateMRise(void)
{
	...
	switch(STState)
	{
		...
		case    SSRun:
		{
			if(DF.PWMENFlag==0) // Проверка флага
			{
				...
				u2 = 0;
				u3 = 0;
				HAL_HRTIM_WaveformOutputStart(&hhrtim1, HRTIM_OUTPUT_TA1|HRTIM_OUTPUT_TA2); // Запуск таймера
				HAL_HRTIM_WaveformOutputStart(&hhrtim1, HRTIM_OUTPUT_TB1|HRTIM_OUTPUT_TB2); // Запуск таймера		
			}
			// Устанавливаем флаг
			DF.PWMENFlag=1;
...
void MX_OLED_Init(void)
{
  ...
  ST7789_SetBL(100);
	ST7789_print_7x11(10,0,GREEN,BLACK,1,"Buck-Boost V-Loop Type3");
...
void OLEDShow(void)
{
	...
	switch(DF.ErrFlag)
	{
		case  F_NOERR : // нет ошибки
		{
			ST7789_print_7x11(50,200,YELLOW,BLACK,0,"F_NOERR   ");
			break;
		}
		case  F_SW_VIN_UVP : // низкое входное напряжение
		{
			ST7789_print_7x11(50,200,YELLOW,BLACK,0,"F_SW_VIN_UVP   ");
			break;
		}
		case  F_SW_VIN_OVP : // высокое входное напряжение
		{
			ST7789_print_7x11(50,200,YELLOW,BLACK,0,"F_SW_VIN_OVP   ");
			break;
		}
		case  F_SW_VOUT_UVP : // низкое напряжение на выходе
		{
			ST7789_print_7x11(50,200,YELLOW,BLACK,0,"F_SW_VOUT_UVP   ");
			break;
		}
		case  F_SW_VOUT_OVP : // высокое напряжение на выходе
		{
			ST7789_print_7x11(50,200,YELLOW,BLACK,0,"F_SW_VOUT_OVP   ");
			break;
		}
		case  F_SW_IOUT_OCP : // перегрузка по току на выходе
		{
			ST7789_print_7x11(50,200,YELLOW,BLACK,0,"F_SW_IOUT_OCP   ");
			break;
		}
		case  F_SW_SHORT : // короткое замыкание на выходе
		{
			ST7789_print_7x11(50,200,YELLOW,BLACK,0,"F_SW_SHORT   ");
			break;
		}
	}
}
