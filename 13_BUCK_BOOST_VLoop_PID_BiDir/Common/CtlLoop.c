...
CCMRAM void BuckBoostVLoopCtlPID(void)
{
	...
	HRTIM1->sTimerxRegs[HRTIM_TIMERINDEX_TIMER_B].CMP1xR = CtrValue.BuckDuty * PERIOD>>12; //buck
  HRTIM1->sTimerxRegs[HRTIM_TIMERINDEX_TIMER_B].CMP3xR = HRTIM1->sTimerxRegs[HRTIM_TIMERINDEX_TIMER_B].CMP1xR>>1; //ADC триггер
	HRTIM1->sTimerxRegs[HRTIM_TIMERINDEX_TIMER_A].CMP1xR = PERIOD - (CtrValue.BoostDuty * PERIOD>>12); //Boost
}
