...
void MX_OLED_Init(void)
{
  ...
  ST7789_SetBL(100);
	ST7789_print_7x11(10,0,GREEN,BLACK,1,"Buck-Boost Open Loop");
...
**     Description : Вывод значений на экран
**     Parameters  :
**     Returns     :
** ===================================================================*/
void OLEDShow(void)
{
	...
	VoutT = (VoutT + (SADC.VoutAvg*6800>>12))>>1;
	IoutT = (IoutT + (SADC.IoutAvg*1400>>12))>>1;
	VinT = (VinT + (SADC.VinAvg*6800>>12))>>1;
	IinT = (IinT + (SADC.IinAvg*2200>>12))>>1;
